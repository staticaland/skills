...
`extensions.autoUpdateDelay` since **1.125** (1.123 shipped a fixed two-hour delay, and 1.125 made it configurable). The value is hours, defaulting to `2`. In `settings.json`:
