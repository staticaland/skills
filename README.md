...
- **[writing-revision](./writing-tools/skills/writing-revision/SKILL.md)**
  (skill) - Makes text clear, scannable, and action-oriented for busy readers.
- **[Kontrollert norsk](./writing-tools/skills/kontrollert-norsk/SKILL.md)**
...
- **[dependency-cooldown](./devops-tools/skills/dependency-cooldown/SKILL.md)**
...
- **[frozen-install](./devops-tools/skills/frozen-install/SKILL.md)** (skill) -
...
- **[install-scripts](./devops-tools/skills/install-scripts/SKILL.md)**
...
- **[mise-setup](./devops-tools/skills/mise-setup/SKILL.md)** (skill) -
  ...
  with a lockfile.
- **[parallel-steps](./devops-tools/skills/parallel-steps/SKILL.md)** (skill) -
...
- **[progressive-disclosure](./ai-tools/skills/progressive-disclosure/SKILL.md)**
...
- **[skill-analyzer](./ai-tools/skills/skill-analyzer/SKILL.md)** (skill) -
...
- **[anki-flashcards](./learning-tools/skills/anki-flashcards/SKILL.md)**
